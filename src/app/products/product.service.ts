...
export class ProductService {
    ...
    private createProduct(product: IProduct, headers: HttpHeaders): Observable<IProduct> {
        // product.id is set to null because the current backend server required the id to be null to assign a new id.
        // it will then set the product.id to the next available id.
        product.id = null;
